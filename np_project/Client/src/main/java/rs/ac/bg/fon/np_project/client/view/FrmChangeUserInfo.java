...
import rs.ac.bg.fon.np_project.client.jsonReport.JsonReport;
...
public class FrmChangeUserInfo extends javax.swing.JDialog {
   ...
   private void initComponents() {
       ...
       jButton1.setText("Generisi json");
   ...
   private void btnGenerisiJSON(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerisiJSON
	  
       try {
    	   jsonReport();
		   JOptionPane.showMessageDialog(this, "Sistem je uspesno izgenerisao json!");
	} catch (Exception ex) {
		JOptionPane.showMessageDialog(this, "Neuspešno generisanje json-a.", "Error", JOptionPane.ERROR_MESSAGE);
	}
   }//GEN-LAST:event_btnGenerisiJSON

   public void jsonReport() {
       JsonReport.generateReport(user);
   }
